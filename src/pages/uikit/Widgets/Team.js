...
const TeamMembers = () => {
    return <Card>
        <CardBody className="pt-2">
            ...
            <Member image={avatarImg7} name="Admin N" description="Senior Sales Guy" />
                ...
                <Col sm={6}>
                    <ul className="list-unstyled ml-sm-3 pl-sm-5 mt-4 mt-sm-0">
                        ...
                        <li className="mb-4">
                            ...
                            <h6 className="mt-1 font-size-16">Admin React Planning</h6>
                        </li>
                        <li>
...
const Chat = () => {
    const chatMessages = [
        ...
        { id: 4, userPic: avatarImg7, userName: 'Admin', text: "Wow that's great!", postedOn: '10:03' },
        { id: 5, userPic: avatarImg7, userName: 'Admin', text: 'Cool!', postedOn: '10:03' },
    ];
            ...
            <CardBody className="pt-2 pb-3">
                ...
                <PerfectScrollbar style={{ maxHeight: '339px' }}>
                    <TaskList>
                        ...
                        <TaskItem title='Write a release note for Admin' due_date="24 Aug, 2019" className="mt-2" />
            ...
            <Media className="mt-5">
                ...
                <Media body>
                    <h6 className="mt-0 mb-0 font-size-15 font-weight-normal">
                        <a href="/" className="font-weight-bold">Admin</a> has attached design-draft.sketch in project <span className="font-weight-bold text-primary">Admin</span>
                    </h6>
                ...
                <Media body>
                    <h6 className="mt-0 mb-0 font-size-15 font-weight-normal">
                        <a href="/" className="font-weight-bold">Mannat</a> has reacted with <i className='uil uil-thumbs-up text-success font-size-13'></i> on comment from <span
                            className="font-weight-bold text-primary">Admin</span> on project <span className="font-weight-bold text-primary">Admin</span>
                    </h6>
                    ...
                    <h6 className="mt-0 mb-0 font-size-15 font-weight-normal">
                        <a href="/" className="font-weight-bold">Dhyani</a> has reacted with <i
                            className='uil uil-heart-sign text-danger font-size-13'></i> on comment
                                                from <span className="font-weight-bold text-primary">Admin</span> on project <span className="font-weight-bold text-primary">Admin</span>
                    </h6>
                    <p className="text-muted">14 Min Ago</p>
                </Media>
            </Media>
