        ...
        <Row>
                ...
                <Card>
                    <CardBody className="pb-0">
                        <div className="text-center mt-3">
                            ...
                            <h5 className="mt-2 mb-0">Admin N</h5>
                            ...
                            <div className="mt-4 pt-3 border-top text-left">
                                <p className="text-muted mb-2">Hi I'm Admin. I am user experience and user
                                    interface designer.
            ...
            <Col md={6} xl={3}>
                <Card className="profile-widget">
                    <img src={avatarImg2} alt="Admin" className="card-img-top" />
                ...
                <Card>
                    <CardBody>
                        ...
                        <div className="mt-1 pt-2 border-top text-left">
                            <p className="text-muted mb-2">Hi I'm Admin. I am foodie and love to eat different cuisine!</p>
                        </div>
            ...
            <Col md={6} xl={3}>
                <Card>
                    <Row className="no-gutters">
                        ...
                        <Col md={8}>
                            <CardBody>
                                <h5 className="card-title mb-1">Admin N</h5>
                ...
                <Card>
                    <CardBody className="p-3">
                        <Media>
                            ...
                            <Media body>
                                <h5 className="mt-1 mb-0">Admin N</h5>
