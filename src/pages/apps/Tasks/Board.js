                            ...
                            <Row className="align-items-center">
                                <Col>
                                    ...
                                    <UncontrolledDropdown className="d-inline">
                                        ...
                                        <DropdownMenu>
                                            <DropdownItem>
                                                <HardDrive className="icon-dual icon-xs mr-2"></HardDrive>Admin Design
                                            </DropdownItem>
                                            <DropdownItem>
                                            ...
                                            <DropdownItem divider />
                                            <DropdownItem>
                                                <FolderPlus className="icon-dual icon-xs mr-2" data-feather="briefcase"></FolderPlus>Admin Angular
                                            </DropdownItem>
                                            <DropdownItem>
                                                <FolderPlus className="icon-dual icon-xs mr-2" data-feather="briefcase"></FolderPlus>Admin React
                                            </DropdownItem>
                                        </DropdownMenu>
                                    </UncontrolledDropdown>
                                </Col>
