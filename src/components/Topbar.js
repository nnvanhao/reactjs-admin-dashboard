          ...
          <Container fluid>
            ...
            <Link to="/" className="navbar-brand mr-0 mr-md-2 logo">
              <span className="logo-lg">
                ...
                <span className="d-inline h5 ml-2 text-logo">Admin</span>
              </span>
            ...
            <ul className="navbar-nav flex-row ml-auto d-flex list-unstyled topnav-menu float-right mb-0">
              ...
              <ProfileDropdown profilePic={profilePic} menuItems={ProfileMenus} username={'Admin N'} description="Administrator" />
            </ul>
